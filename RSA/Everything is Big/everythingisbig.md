...
## Đề bài
Đề bài sử dụng đoạn code dưới đây để tạo một mô hình mã hóa RSA
```python
#!/usr/bin/env python3
...
$$e*d \equiv 1(mod\ phi) \Leftrightarrow e*d - k*phi = 1$$
...
def wienerAttack(e, n):
    cf = continued_fraction(e/Integer(n))
